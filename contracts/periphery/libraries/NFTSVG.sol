...
library NFTSVG {
    ...
    function generateSVGDefs(SVGParams memory params) private pure returns (string memory svg) {
        svg = string(
            abi.encodePacked(
                ...
                '<defs>',
                '<style type="text/css">@import url("https://spoqa.github.io/spoqa-han-sans/css/SpoqaHanSansNeo.css");</style>'
    ...
    function generateSVGBorderText(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<textPath startOffset="-100%" fill="white" font-family="\'Spoqa Han Sans Neo\', monospace" font-size="10px" xlink:href="#text-path-a">',
                baseToken,
                unicode' • ',
                baseTokenSymbol,
                ' <animate additive="sum" attributeName="startOffset" from="0%" to="100%" begin="0s" dur="30s" repeatCount="indefinite" />',
                '</textPath> <textPath startOffset="0%" fill="white" font-family="\'Spoqa Han Sans Neo\', monospace" font-size="10px" xlink:href="#text-path-a">',
                baseToken,
                unicode' • ',
                baseTokenSymbol,
                ' <animate additive="sum" attributeName="startOffset" from="0%" to="100%" begin="0s" dur="30s" repeatCount="indefinite" /> </textPath>',
                '<textPath startOffset="50%" fill="white" font-family="\'Spoqa Han Sans Neo\', monospace" font-size="10px" xlink:href="#text-path-a">',
                quoteToken,
                unicode' • ',
                quoteTokenSymbol,
                ' <animate additive="sum" attributeName="startOffset" from="0%" to="100%" begin="0s" dur="30s"',
                ' repeatCount="indefinite" /></textPath><textPath startOffset="-50%" fill="white" font-family="\'Spoqa Han Sans Neo\', monospace" font-size="10px" xlink:href="#text-path-a">',
                quoteToken,
                unicode' • ',
                quoteTokenSymbol,
    ...
    function generateSVGCardMantle(
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<text y="50px" x="32px" fill="orange" font-family="\'Spoqa Han Sans Neo\', monospace" font-weight="700" font-size="15px">Kaia KLAYswap V3 NFT</text>',
                '<text y="90px" x="32px" fill="white" font-family="\'Spoqa Han Sans Neo\', monospace" font-weight="700" font-size="36px">',
                quoteTokenSymbol,
                '/',
                baseTokenSymbol,
                '</text><text y="135px" x="32px" fill="white" font-family="\'Spoqa Han Sans Neo\', monospace" font-weight="700" font-size="36px">',
                feeTier,
                '</text></g>',
    ...
    function generateSVGPositionDataAndLocationCurve(
        ...
        uint256 str1length = bytes(tokenId).length + 10;
        uint256 str2length = bytes(tickLowerStr).length + 14;
        uint256 str3length = bytes(tickUpperStr).length + 14;
        ...
        svg = string(
            abi.encodePacked(
                ...
                '<text x="12px" y="17px" font-family="\'Spoqa Han Sans Neo\', monospace" font-size="12px" fill="white"><tspan fill="rgba(255,255,255,0.6)">Token ID: </tspan>',
                tokenId,
                '</text></g>',
                ...
                'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)" />',
                '<text x="12px" y="17px" font-family="\'Spoqa Han Sans Neo\', monospace" font-size="12px" fill="white"><tspan fill="rgba(255,255,255,0.6)">Minimum Tick: </tspan>',
                tickLowerStr,
                '</text></g>',
                ...
                'px" height="26px" rx="8px" ry="8px" fill="rgba(0,0,0,0.6)" />',
                '<text x="12px" y="17px" font-family="\'Spoqa Han Sans Neo\', monospace" font-size="12px" fill="white"><tspan fill="rgba(255,255,255,0.6)">Maximum Tick: </tspan>',
                tickUpperStr,
                '</text></g>'
