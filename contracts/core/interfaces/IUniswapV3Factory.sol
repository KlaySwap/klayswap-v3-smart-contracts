...
interface IUniswapV3Factory {
    ...
    /// @notice Emitted when the policyAdmin of the factory is changed
    /// @param policyAdmin The policyAdmin
    ...
    /// @notice Updates the policyAdmin of the factory
    /// @dev Must be called by the current owner
    /// @param _policyAdmin The new owner of the factory
